    ...
    <>
      ...
      <section className="relative">
        <div className="absolute inset-0 -z-10">
          <Image src="/images/placeholders/hero.png" alt="Chantier BTP" fill className="object-cover" priority />
        ...
        <Container className="py-16 md:py-28 text-white">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="/contact" className="inline-flex items-center rounded-2xl bg-cyan-700 px-5 py-3 font-medium text-white hover:bg-cyan-800">Demander un devis</a>
